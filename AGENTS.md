...
- **Creating, reading, labelling or closing a ticket**, or writing a ticket or PR body: GitHub Issues on `chizhangucb/software-factory`, driven with `gh` as `docs/agents/issue-tracker.md` says.
