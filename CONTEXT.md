...
_Avoid_: escalation (the factory is not giving up: a fresh verdict follows the author's fix), hand-back (the PR was never the factory's to hand anywhere), stood down (the dispatcher's word, for leaving alone a ticket an open PR claims).
