...
| `factory/merge-gate/` | `merge-gate.ts`, `changed-files.ts`, `red-green.ts`, `test-integrity.ts`, their three `.test.ts` (`removes.ts` and its test lived here from #13 until #138) |
